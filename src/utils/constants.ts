// Reference: https://github.com/ritual-net/infernet-node/blob/87ecd20895e1e754d33801b29dd82c5c6e43a566/src/utils/constants.py.
...
export const DELEGATED_SIGNER_ABI: Abi = [
  {
    type: 'function',
    name: 'getSigner',
    inputs: [],
...
export const SUBSCRIPTION_CONSUMER_ABI: Abi = [
  {
    type: 'function',
...
export const COORDINATOR_ABI: Abi = [
  {
    type: 'constructor',
    inputs: [
      {
...
export const WALLET_FACTORY_ABI: Abi = [
  {
    type: 'function',
    name: 'isValidWallet',
...
export const PAYMENT_WALLET_ABI: Abi = [
  {
    type: 'function',
    name: 'approve',
    inputs: [
